...
/**
 * Provides the local service interface for FormEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FormEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FormEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FormEntryLocalServiceUtil} to access the form entry local service. Add custom service methods to <code>com.liferay.gs.form.service.impl.FormEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public FormEntry createFormEntry(long formId);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public FormEntry deleteFormEntry(long formId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FormEntry fetchFormEntry(long formId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FormEntry getFormEntry(long formId) throws PortalException;
